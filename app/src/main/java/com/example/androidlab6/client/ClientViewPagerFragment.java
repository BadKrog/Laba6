...
public class ClientViewPagerFragment extends Fragment {
    private int position;

    public ClientViewPagerFragment(int position) {
        super();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ClientViewPagerAdapter adapter = new ClientViewPagerAdapter(getContext());
